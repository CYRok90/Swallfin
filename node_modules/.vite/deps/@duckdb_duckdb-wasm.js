...
var O = class {
  ...
  async reset() {
    let e = new d("RESET", null);
    return await this.postTask(e);
  }
  async ping() {
    let e = new d("PING", null);
    await this.postTask(e);
  }
  async dropFile(e) {
    let r = new d("DROP_FILE", e);
    return await this.postTask(r);
  }
  async dropFiles() {
    let e = new d("DROP_FILES", null);
    return await this.postTask(e);
  }
  async flushFiles() {
    let e = new d("FLUSH_FILES", null);
    return await this.postTask(e);
  }
  async instantiate(e, r = null, t = (o) => {
  }) {
    this._onInstantiationProgress.push(t);
    let o = new d("INSTANTIATE", [e, r]);
    return await this.postTask(o);
  }
  async getVersion() {
    let e = new d("GET_VERSION", null);
    return await this.postTask(e);
  }
  async getFeatureFlags() {
    let e = new d("GET_FEATURE_FLAGS", null);
    return await this.postTask(e);
  }
  async open(e) {
    let r = new d("OPEN", e);
  ...
  async tokenize(e) {
    let r = new d("TOKENIZE", e);
    return await this.postTask(r);
  }
  async connectInternal() {
    let e = new d("CONNECT", null);
    return await this.postTask(e);
  }
  async connect() {
  ...
  async disconnect(e) {
    let r = new d("DISCONNECT", e);
    await this.postTask(r);
  }
  async runQuery(e, r) {
    let t = new d("RUN_QUERY", [e, r]);
    return await this.postTask(t);
  }
  async startPendingQuery(e, r) {
    let t = new d("START_PENDING_QUERY", [e, r]);
    return await this.postTask(t);
  }
  async pollPendingQuery(e) {
    let r = new d("POLL_PENDING_QUERY", e);
    return await this.postTask(r);
  }
  async cancelPendingQuery(e) {
    let r = new d("CANCEL_PENDING_QUERY", e);
    return await this.postTask(r);
  }
  async fetchQueryResults(e) {
    let r = new d("FETCH_QUERY_RESULTS", e);
    return await this.postTask(r);
  }
  async getTableNames(e, r) {
    let t = new d("GET_TABLE_NAMES", [e, r]);
    return await this.postTask(t);
  }
  async createPrepared(e, r) {
    let t = new d("CREATE_PREPARED", [e, r]);
    return await this.postTask(t);
  }
  async closePrepared(e, r) {
    let t = new d("CLOSE_PREPARED", [e, r]);
    await this.postTask(t);
  }
  async runPrepared(e, r, t) {
    let o = new d("RUN_PREPARED", [e, r, t]);
    return await this.postTask(o);
  }
  async sendPrepared(e, r, t) {
    let o = new d("SEND_PREPARED", [e, r, t]);
    return await this.postTask(o);
  }
  async globFiles(e) {
    let r = new d("GLOB_FILE_INFOS", e);
    return await this.postTask(r);
  }
  ...
  async registerFileURL(e, r, t, o) {
    r === void 0 && (r = e);
    let a = new d("REGISTER_FILE_URL", [e, r, t, o]);
    await this.postTask(a);
  }
  async registerEmptyFileBuffer(e) {
  }
  async registerFileBuffer(e, r) {
    let t = new d("REGISTER_FILE_BUFFER", [e, r]);
    await this.postTask(t, [r.buffer]);
  }
  async registerFileHandle(e, r, t, o) {
    let a = new d("REGISTER_FILE_HANDLE", [e, r, t, o]);
    await this.postTask(a, []);
  }
  async collectFileStatistics(e, r) {
    let t = new d("COLLECT_FILE_STATISTICS", [e, r]);
    await this.postTask(t, []);
  }
  async exportFileStatistics(e) {
    let r = new d("EXPORT_FILE_STATISTICS", e);
    return await this.postTask(r, []);
  }
  async copyFileToBuffer(e) {
    let r = new d("COPY_FILE_TO_BUFFER", e);
    return await this.postTask(r);
  }
  async copyFileToPath(e, r) {
    let t = new d("COPY_FILE_TO_PATH", [e, r]);
    await this.postTask(t);
  }
  async insertArrowFromIPCStream(e, r, t) {
    if (r.length == 0) return;
    let o = new d("INSERT_ARROW_FROM_IPC_STREAM", [e, r, t]);
  ...
  async insertCSVFromPath(e, r, t) {
    ...
    let o = new d("IMPORT_CSV_FROM_PATH", [e, r, t]);
  ...
  async insertJSONFromPath(e, r, t) {
    ...
    let o = new d("IMPORT_JSON_FROM_PATH", [e, r, t]);
    await this.postTask(o);
  }
};
var w = class {
