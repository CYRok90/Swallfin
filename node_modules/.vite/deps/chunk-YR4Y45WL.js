...
var enableFns = /* @__PURE__ */ new Set();
var onEnableDebug = (fn) => {
  if (isDebug()) fn();
...
// ../../node_modules/@evidence-dev/sdk/node_modules/@uwdata/mosaic-sql/src/desc.js
function desc(expr) {
  const e = asColumn(expr);
  return sql`${e} DESC NULLS LAST`.annotate({ label: e == null ? void 0 : e.label, desc: true });
}

// ../../node_modules/@evidence-dev/sdk/node_modules/@uwdata/mosaic-sql/src/literal.js
var literal = (value) => ({
  value,
...
// ../../node_modules/@evidence-dev/sdk/node_modules/@uwdata/mosaic-sql/src/spatial.js
...
var Query = class _Query2 {
  ...
  static describe(query) {
    ...
    return Object.assign(q, {
      describe: true,
      clone: () => _Query2.describe(clone.call(q)),
...
var _value, _data, _dataQueryTime, _length, _lengthQueryTime, _columns, _mockRow, _columnsQueryTime, ___error, _Query_instances, error_get, error_set, _query, _originalText, _inFlightQueries, _markInFlight, _globalHandlerMap, _globalEmit, _scoreThreshold, _score, _calculateScore, _sharedDataPromise, _fetchData, _sharedLengthPromise, _fetchLength, _sharedColumnsPromise, _fetchColumns, _buildProxy, _cache, _addToCache, _getFromCache, _cacheCleanup, _devModeBootstrapped, _devModeBootstraps, _debugStatic, _debugStyledStatic, _debug, _debugStyled, _constructing, _id, _hash, _opts, inheritableOpts_get, _executeQuery, _createdStack, _subscribers, _publishIdx, _handlerMap, _emit, _aggFns, _checkAggFn;
var _Query = class _Query {
  ...
  constructor(query, executeQuery, opts = {}) {
    ...
    __privateAdd(this, _fetchData, () => {
      ...
      if (__privateGet(this, _Query_instances, error_get)) {
...
${this.text.trim()}
      ...
      const resolved = resolveMaybePromise(
        ...
        (e, isPromise) => {
          __privateSet(this, _Query_instances, e, error_set);
    ...
    __publicField(this, "fetch", () => {
      const cols = __privateGet(this, _fetchColumns).call(this);
      if (cols instanceof Promise && /* noResolve will always return a promise, even when fetch is synchronous */
      !this.opts.noResolve) {
        return Promise.allSettled([__privateGet(this, _fetchColumns).call(this), __privateGet(this, _fetchData).call(this)]).then(() => this.value);
      }
...
${this.text.trim()}`, this.id);
    ...
    __privateAdd(this, _fetchLength, () => {
      ...
      if (__privateGet(this, _Query_instances, error_get)) {
        __privateGet(this, _debug).call(this, "length error", "Refusing to execute length query, store has an error state", __privateGet(this, _Query_instances, error_get));
        __privateGet(this, _sharedLengthPromise).reject(__privateGet(this, _Query_instances, error_get));
...
SELECT COUNT(*) as rowCount FROM (${this.text.trim()})
    ...
    __privateAdd(this, _fetchColumns, () => {
      if (__privateGet(this, _Query_instances, error_get)) {
        __privateGet(this, _debug).call(this, "cols query error", "Refusing to execute columns query, store has an error state", __privateGet(this, _Query_instances, error_get));
...
DESCRIBE ${this.text.trim()}
        ...
        new Proxy(
          ...
          [],
          {
            ...
            get: (_self, rawProp) => {
              ...
              if (prop === "constructor") return __privateGet(this, _data).constructor;
              if (prop === "toString") return __privateGet(this, _data).toString.bind(__privateGet(this, _data));
              const target = prop in this ? this : __privateGet(this, _data) && prop in __privateGet(this, _data) ? __privateGet(this, _data) : null;
              if (target === null)
                if (typeof prop !== "number") return void 0;
                else {
                  if (this.lengthLoaded && prop > __privateGet(this, _length)) return void 0;
    ...
    __privateAdd(this, _createdStack);
    ////////////////////////////////////
    ...
    __publicField(this, "publish", (source) => {
      if (__privateWrapper(this, _publishIdx)._++ > 1e5) throw new Error("Query published too many times.");
      __privateGet(this, _debug).call(this, "publish", `Publishing triggered by ${source}`);
    ...
    __publicField(this, "withOrdinal", (windowStatement) => {
      ...
      return _Query.create(newQ, __privateGet(this, _executeQuery), {
        ...__privateGet(this, _Query_instances, inheritableOpts_get),
        knownColumns: __privateGet(this, _columns)
      });
    });
    /**
     ...
     */
    __publicField(this, "search", (searchTerm, searchCol, searchThreshold) => {
      ...
      const statements = cols.map((col) => {
        ...
        const exactSubMatch = escapedSearchTerm.length >= 1 ? sql`CASE WHEN lower("${col.trim()}") LIKE lower('%${escapedSearchTerm.split(" ").join("%")}%') THEN 1 ELSE 0 END` : sql`0`;
    ...
    __publicField(this, "agg", (cfg) => {
      ...
      for (const [aggType, aggArgs] of Object.entries(cfg)) {
        if (!__privateGet(_a = _Query, _checkAggFn).call(_a, aggType)) throw new Error(`Unknown agg function: ${aggType}`);
    ...
    var _a;
    __privateSet(this, _createdStack, (_a = new Error().stack) == null ? void 0 : _a.split("\n").slice(2).map((line) => line.slice("    at ".length)).join("\n"));
    const {
      id,
      initialData = void 0,
      knownColumns = void 0,
    ...
    if (query && typeof query !== "string") __privateSet(this, _query, query);
    else if (query) {
      ...
      __privateSet(this, _Query_instances, new Error(`Refusing to create Query: No Query Text provided`), error_set);
      return;
    }
    if (initialError) {
      __privateSet(this, _Query_instances, initialError, error_set);
      return;
    }
    if (initialData) {
    ...
    if (knownColumns) {
      ...
      __privateGet(this, _debug).call(this, "known columns", "Created with known columns", knownColumns);
  ...
  get error() {
    return __privateGet(this, _Query_instances, error_get);
  }
  /**
  ...
  get createdStack() {
    return __privateGet(this, _createdStack);
  }
  ////////////////////////////////////
  /// </ QueryBuilder Interface /> ///
  ////////////////////////////////////
...
__publicField(_Query, "emptyCache", () => {
  ...
  __privateGet(_a = _Query, _globalEmit).call(_a, "cacheCleared", void 0);
});
/**
 * @param {Query<any>} q
 */
__privateAdd(_Query, _addToCache, (q) => {
  ...
  __privateGet(_a = _Query, _debugStatic).call(_a, "cache", `Added to cache: ${q.hash}`, {
...
__publicField(_Query, "createReactive", (reactiveOpts, opts, initialQuery) => {
  ...
  const waitFor = (
    ...
    (nextQuery, newOpts) => {
      ...
      const newQuery = _Query.isQuery(nextQuery) ? nextQuery : createFn(
        ...
        Object.assign({}, opts, { initialData: void 0, initialError: void 0 }, newOpts)
      );
  ...
  return (queryText, newOpts) => {
    ...
    if ((_b = (_a = import.meta.hot) == null ? void 0 : _a.data) == null ? void 0 : _b.hmr) removeInitialState();
...
__privateAdd(_Query, _devModeBootstraps, () => {
  if (!import.meta.hot || __privateGet(_Query, _devModeBootstrapped)) return;
...
__publicField(_Query, "create", (query, executeQuery, optsOrId, maybeOpts) => {
  ...
  __privateGet(_g = _Query, _globalEmit).call(_g, "queryCreated", {
    raw: output,
...
var duckdbSerialize = (value, opts = { serializeStrings: true }) => {
  ...
  if (Array.isArray(value)) return `[${value.map((x2) => duckdbSerialize(x2, opts)).join(", ")}]`;
...
var GetOwnKey = Symbol("GetOwnKey");
var GetOwnPath = Symbol("GetOwnPath");
var GetParent = Symbol("GetParent");
...
var hasUnsetValues = (strings, ...args) => {
  const unsetValues = args.filter((arg) => arg == null ? void 0 : arg[Unset]);
...
//# sourceMappingURL=chunk-YR4Y45WL.js.map
